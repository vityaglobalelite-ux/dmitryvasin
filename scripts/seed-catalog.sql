...
('c0a7a109-0001-4000-8000-000000000001', 'lifehack',  49000, 'rub',  30, '/assets/site/catalog/covers/silhouette.png',       500,  '1', ARRAY['Осознавание','Ось'], NULL, true),
...
('c0a7a109-0001-4000-8000-000000000009', 'lifehack',  45000, 'rub',  30, '/assets/site/catalog/covers/thumb-01.webp',        380,  '1', ARRAY['Осознавание','Объятие'], NULL, true),
('c0a7a109-0001-4000-8000-000000000010', 'lifehack',  55000, 'rub',  30, '/assets/site/catalog/covers/thumb-02.webp',        640,  '2', ARRAY['Техника','Ось'], NULL, true),
('c0a7a109-0001-4000-8000-000000000011', 'lifehack',  52000, 'rub',  30, '/assets/site/catalog/covers/photo-dancer.webp',    510,  '1', ARRAY['Музыкальность'], NULL, true),
...
('c0a7a109-0001-4000-8000-000000000004', 'lesson',   169000, 'rub',  90, '/assets/site/catalog/covers/photo-dance.webp',    2292,  '3', ARRAY['Музыкальность','Осознавание'], NULL, true),
('c0a7a109-0001-4000-8000-000000000012', 'lesson',   139000, 'rub',  90, '/assets/site/catalog/covers/thumb-03.webp',       2100,  '1', ARRAY['Техника','Шаг'], NULL, true),
('c0a7a109-0001-4000-8000-000000000013', 'lesson',   159000, 'rub',  90, '/assets/site/catalog/covers/thumb-04.webp',       2460,  '2', ARRAY['Техника','Поворот'], NULL, true),
('c0a7a109-0001-4000-8000-000000000014', 'lesson',   179000, 'rub',  90, '/assets/site/catalog/covers/thumb-05.webp',       2640,  '3', ARRAY['Техника','Сакада'], NULL, true),
('c0a7a109-0001-4000-8000-000000000015', 'lesson',   155000, 'rub',  90, '/assets/site/catalog/covers/photo-lessons.webp',  2340,  '2', ARRAY['Взаимодействие','Объятие'], NULL, true),
('c0a7a109-0001-4000-8000-000000000016', 'lesson',   165000, 'rub',  90, '/assets/site/catalog/covers/photo-liza.webp',     2580,  '3', ARRAY['Техника','Ведение'], NULL, true),

('c0a7a109-0001-4000-8000-000000000005', 'course',   990000, 'rub', 180, '/assets/site/catalog/covers/couple-stage.jpg',   21600,  '2', ARRAY['Техника','Взаимодействие','Осознавание'], 6, true),
('c0a7a109-0001-4000-8000-000000000017', 'course',  1290000, 'rub', 180, '/assets/site/catalog/covers/directions-dmitry.png', 28800, '3', ARRAY['Музыкальность','Осознавание'], 8, true),
('c0a7a109-0001-4000-8000-000000000018', 'course',  1190000, 'rub', 180, '/assets/site/catalog/covers/studio-bg.png',      25200,  '2', ARRAY['Техника','Ось','Шаг'], 7, true),
('c0a7a109-0001-4000-8000-000000000019', 'course',  1490000, 'rub', 365, '/assets/site/catalog/covers/photo-dmitry.webp',  32400,  '3', ARRAY['Взаимодействие','Техника'], 10, true),

('c0a7a109-0001-4000-8000-000000000006', 'extra',    79000, 'rub',  60, '/assets/site/catalog/covers/thumb-06.webp',       1320,  '1', ARRAY['Осознавание'], NULL, true),
('c0a7a109-0001-4000-8000-000000000020', 'extra',    69000, 'rub',  60, '/assets/site/catalog/covers/thumb-07.webp',        900,  '1', ARRAY['Взаимодействие'], NULL, true),
('c0a7a109-0001-4000-8000-000000000021', 'extra',    89000, 'rub',  90, '/assets/site/catalog/covers/thumb-08.webp',       1500,  '2', ARRAY['Техника'], NULL, true),
...
('c0a7a109-0001-4000-8000-000000000022', 'research', 229000, 'rub', 120, '/assets/site/catalog/covers/photo-dancer.webp',   3300,  '4', ARRAY['Осознавание','Объятие'], NULL, true),
('c0a7a109-0001-4000-8000-000000000023', 'research', 259000, 'rub', 120, '/assets/site/catalog/covers/couple-gold.png',    3600,  '3', ARRAY['Вариативность','Техника'], NULL, true),

('c0a7a109-0001-4000-8000-000000000008', 'peek',    199000, 'rub',  90, '/assets/site/catalog/covers/studio-dmitry.png',   3270,  '3', ARRAY['Взаимодействие','Техника'], NULL, true),
('c0a7a109-0001-4000-8000-000000000024', 'peek',    189000, 'rub',  90, '/assets/site/catalog/covers/photo-lessons.webp',  3120,  '2', ARRAY['Взаимодействие','Осознавание'], NULL, true),
('c0a7a109-0001-4000-8000-000000000025', 'peek',    219000, 'rub',  90, '/assets/site/catalog/covers/photo-liza.webp',     3540,  '3', ARRAY['Техника','Объятие'], NULL, true)
