...
export const homeMobileBreaks = {
  ...
  dirTexts: [
    ...
    [
      "Разбираемся, почему одни",
      "движения получаются легко, а",
      "другие требуют лишних усилий.",
    ],
    [
      "Уходим от\u00a0привычных",
      "музыкальных решений и\u00a0ищем",
      "новые способы взаимодействия",
      "с\u00a0музыкой.",
    ],
    [
      "Ищем более понятные, точные и",
      "комфортные способы",
      "взаимодействия в\u00a0паре.",
    ],
    [
      "Постепенно обнаруживаем, что",
      "вариантов продолжения",
      "движения гораздо больше, чем",
