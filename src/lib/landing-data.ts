...
export const programMonths = [
  ...
  },
  {
    ...
    nodes: [
      { id: 17, title: "Урок 17", skills: [{ label: "Взаимодействие", delta: 1 }] },
      { id: 18, title: "Урок 18", skills: [{ label: "Осознавание", delta: 1 }] },
      { id: 19, title: "Урок 19", skills: [{ label: "Техника", delta: 1 }] },
      { id: 20, title: "Урок 20", skills: [{ label: "Музыкальность", delta: 1 }] },
    ],
    lessons: [
      { id: 17, number: "Урок 17", title: "Урок 17", direction: "Взаимодействие", directionIcon: landingAssets.icons.couple, body: "", explore: [] },
      { id: 18, number: "Урок 18", title: "Урок 18", direction: "Осознавание", directionIcon: landingAssets.icons.brainSparkleSm, body: "", explore: [] },
      { id: 19, number: "Урок 19", title: "Урок 19", direction: "Техника", directionIcon: landingAssets.icons.footprint, body: "", explore: [] },
      { id: 20, number: "Урок 20", title: "Урок 20", direction: "Музыкальность", directionIcon: landingAssets.icons.shoeProgress, body: "", explore: [] },
    ],
